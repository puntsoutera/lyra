...
> **Personal note:** I had to use Python 3.10 (not 3.11+) to avoid dependency conflicts with the diff-gaussian-rasterization package on my machine. If you run into build errors, try downgrading first.
